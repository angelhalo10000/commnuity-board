...
ActiveRecord::Schema[8.1].define(version: 2026_04_07_020455) do
  ...
  create_table "blocks", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "name", null: false
  ...
  create_table "circulars", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "organization_id", null: false
  ...
  create_table "notices", id: :string, force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.string "organization_id", null: false
    t.timestamptz "published_at"
  ...
  add_foreign_key "circulars", "organizations"
